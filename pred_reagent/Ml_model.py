...
class MLmodel(object):
    def __init__(self, data_file, model_flag, inputs):
        ...
        (reactants, products, _, catalysts), (_, reagents) = get_data(data_file)

        # labels
        self.mlb = MultiLabelBinarizer()
        Y = self.mlb.fit_transform(reagents)
        np.save('./reagents_labels.npy', self.mlb.classes_)
        print('Number of reagents: ', len(self.mlb.classes_))
